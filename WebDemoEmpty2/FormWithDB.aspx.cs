...
{
    public partial class FormWithDB : System.Web.UI.Page
    {
        ...
        void SelectRecords(string sql = "SELECT * FROM college.students")
        {
        ...
        protected void submitButton_Click(object sender, EventArgs e)
        {
            ...
            string sql = "INSERT INTO college.students (reg_id, first_name, last_name) VALUES (" + regId + ",'" + firstName + "','" + lastName + "')";
