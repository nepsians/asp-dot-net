<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormPage.aspx.cs" Inherits="WebDemoEmpty2.FormPage" %>
            ...
            <div class="form">
                ...
                <div>
                    <div class="list-view">
                        ...
                        <asp:ListBox ID="academicListBox" runat="server" OnSelectedIndexChanged="ListBox1_SelectedIndexChanged"></asp:ListBox>
                        <br />
                    </div>
                </div>
